...
python -m ipdb -c continue projects/human_sf/trainer_v1.py \
  --parallel='none' \
...
JAX_DISABLE_JIT=1 python -m ipdb -c continue projects/human_sf/trainer_v1.py \
  --parallel='none' \
  --run_distributed=False \
  --debug=True \
  --use_wandb=False \
...
# running, parallel
python projects/human_sf/trainer_v1.py \
  --parallel='sbatch' \
